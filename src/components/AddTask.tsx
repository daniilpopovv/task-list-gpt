...
const AddTask = () => {
    ...
    return (
        <div>
            <h1 className="m-5 mb-1 text-4xl font-bold">Добавить задачу</h1>
            <form onSubmit={handleSubmit}>

                <label htmlFor="email" className="m-5 text-sm text-navy-700 dark:text-white font-bold">Default</label>
                <input type="text"
                       value={taskText}
                ...
                <div className="flex flex-row">
                    ...
                    >
                        <div className='flex items-center justify-between flex-1'>
                            <span className='text-md font-medium text-white whitespace-nowrap pr-6'>Добавить</span>
